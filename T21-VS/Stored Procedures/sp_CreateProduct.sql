...
-- If CategoryID is NULL -> Create new Category and return ID in output. 
-- In that case @CategoryName and @CategoryDescription should be provided.

-------------
CREATE   PROCEDURE Shop.sp_CreateProduct
